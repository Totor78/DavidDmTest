...
public class ErzoKafkaResourceIT {
    ...
    @Autowired
    private ErzoKafkaProducer producer;

    @Autowired
    private ErzoKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        ErzoKafkaResource kafkaResource = new ErzoKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/erzo-kafka/publish?message=test"))
